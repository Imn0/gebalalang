use super::{
    compiler::{GVMeCompileContext, GVMeProc},
...
impl<'a> GVMeCompileContext<'a> {
    /// BUILTIN PROCEDURES !!!!
    pub fn generate_mul_procedure_stub(&mut self) -> Result<GVMeProc, String> {
    ...
    pub fn generate_mod_procedure_stub(&mut self) -> Result<GVMeProc, String> {
    ...
    pub fn generate_div_mod_procedure_stub(&mut self) -> Result<GVMeProc, String> {
    ...
    pub fn compile_mul_builtin(&mut self, mut buff: Vec<GVMe>) -> Result<Vec<GVMe>, String> {
        let proc_info = self
            .proc_info
        ...
        self.const_in_acc(&one, &mut buff);
        buff.push(GVMe::STORE(sign_flag));

        buff.push(GVMe::LOAD(arg1));
        buff.push(GVMe::jpos(arg_1_pos.clone()));

        self.const_in_acc(&m_one, &mut buff);
        buff.push(GVMe::STORE(sign_flag));
        self.const_in_acc(&zero, &mut buff);
        buff.push(GVMe::SUB(arg1));
        buff.push(GVMe::STORE(arg1));
        ...
        buff.push(GVMe::LOAD(arg2));
        buff.push(GVMe::jpos(arg_2_pos.clone()));

        self.const_in_acc(&zero, &mut buff);

        buff.push(GVMe::SUB(sign_flag));
        buff.push(GVMe::STORE(sign_flag));
        self.const_in_acc(&zero, &mut buff);

        buff.push(GVMe::SUB(arg2));
        buff.push(GVMe::STORE(arg2));
        ...
        buff.push(GVMe::SUB(arg1));
        buff.push(GVMe::jpos(dont_swap));
        buff.push(GVMe::LOAD(arg1));
        buff.push(GVMe::STORE(tmp));
        buff.push(GVMe::LOAD(arg2));
        buff.push(GVMe::STORE(arg1));
        buff.push(GVMe::LOAD(tmp));
        buff.push(GVMe::STORE(arg2));
        buff.push(GVMe::lbl {
            idx: dont_swap,
            name: format!(""),
        ...
        if self.mul_call_count > 3 {
            ...
            buff.push(GVMe::LOAD(arg2));
            buff.push(GVMe::SUB(last_arg2));
            buff.push(GVMe::jnz(_skip));
            buff.push(GVMe::LOAD(arg1));
            buff.push(GVMe::SUB(last_arg1));
            buff.push(GVMe::jz(loop_end_lbl));
        ...
        self.const_in_acc(&zero, &mut buff);
        buff.push(GVMe::STORE(res));
        buff.push(GVMe::LOAD(arg2));
        if self.mul_call_count > 3 {
            buff.push(GVMe::STORE(last_arg2));
        }
        buff.push(GVMe::STORE(arg2_op));
        buff.push(GVMe::LOAD(arg1));

        if self.mul_call_count > 3 {
            buff.push(GVMe::STORE(last_arg1));
        }
        buff.push(GVMe::STORE(arg1_op));
        // CARRY ON
        buff.push(GVMe::LOAD(arg1_op));
        buff.push(GVMe::lbl {
            idx: loop_start_lbl.clone(),
            name: format!(""),
        });
        buff.push(GVMe::jz(loop_end_lbl.clone()));

        buff.push(GVMe::HALF);
        buff.push(GVMe::ADD(0));
        buff.push(GVMe::SUB(arg1_op));

        buff.push(GVMe::jz(skip_add.clone()));
        buff.push(GVMe::LOAD(arg1_op));
        buff.push(GVMe::LOAD(res));
        buff.push(GVMe::ADD(arg2_op));
        buff.push(GVMe::STORE(res));
        buff.push(GVMe::lbl {
            idx: skip_add,
            name: format!(""),
        ...
        buff.push(GVMe::lbl_jump(loop_start_lbl));
        buff.push(GVMe::lbl {
            idx: loop_end_lbl,
            name: format!(""),
        });
        ...
        buff.push(GVMe::LOAD(sign_flag));
        buff.push(GVMe::jpos(is_pos.clone()));

        self.const_in_acc(&zero, &mut buff);
        buff.push(GVMe::SUB(res));
        buff.push(GVMe::lbl_jump(skip.clone()));
        ...
        buff.push(GVMe::STORE(res_rtn));

        buff.push(GVMe::RTRN(proc_info.return_address));

        Ok(buff)
    }

    pub fn compile_div_mod_builtin(&mut self, mut buff: Vec<GVMe>) -> Result<Vec<GVMe>, String> {
        let proc_info = self
            .proc_info
        ...
        // if b == 0
        buff.push(GVMe::LOAD(arg2));
        buff.push(GVMe::jnz(arg_2_zero));
        self.const_in_acc(&zero, &mut buff);
        buff.push(GVMe::STORE(div_res_rtn));
        buff.push(GVMe::STORE(mod_res_rtn));
        buff.push(GVMe::RTRN(proc_info.return_address));
        buff.push(GVMe::lbl {
            idx: arg_2_zero,
            name: format!(""),
        ...
        // sign = 1, mod_sign = 1
        self.const_in_acc(&one, &mut buff);
        buff.push(GVMe::STORE(arg1_positive));
        buff.push(GVMe::STORE(arg2_positive));
        buff.push(GVMe::STORE(sign_flag));
        ...
        if self.mod_div_call_count > 1 {
            ...
            buff.push(GVMe::LOAD(arg2));
            buff.push(GVMe::SUB(last_arg2));
            buff.push(GVMe::jnz(skip));
            buff.push(GVMe::LOAD(arg1));
            buff.push(GVMe::SUB(last_arg1));
            buff.push(GVMe::jz(loop2_end));
        ...
        self.const_in_acc(&zero, &mut buff);
        buff.push(GVMe::STORE(div_res));

        self.const_in_acc(&one, &mut buff);
        buff.push(GVMe::STORE(power_of_two));

        buff.push(GVMe::LOAD(arg1));
        buff.push(GVMe::STORE(mod_res));
        ...
        */
        ...
        buff.push(GVMe::LOAD(arg2));
        buff.push(GVMe::SUB(mod_res));
        buff.push(GVMe::jpos(loop_exit1.clone()));
        buff.push(GVMe::LOAD(arg2));
        buff.push(GVMe::ADD(arg2));
        buff.push(GVMe::STORE(arg2));

        buff.push(GVMe::LOAD(power_of_two));
        buff.push(GVMe::ADD(power_of_two));
        buff.push(GVMe::STORE(power_of_two));

        buff.push(GVMe::lbl_jump(loop1_start));
        buff.push(GVMe::lbl {
            idx: loop_exit1,
            name: format!(""),
        });
        ...
        */
        ...
        buff.push(GVMe::LOAD(power_of_two));
        buff.push(GVMe::jnegz(loop2_end.clone()));

        buff.push(GVMe::LOAD(mod_res));
        buff.push(GVMe::SUB(arg2));
        buff.push(GVMe::jneg(inner_if_fail.clone()));
        buff.push(GVMe::LOAD(mod_res));
        buff.push(GVMe::SUB(arg2));
        buff.push(GVMe::STORE(mod_res));

        buff.push(GVMe::LOAD(div_res));
        buff.push(GVMe::ADD(power_of_two));
        buff.push(GVMe::STORE(div_res));
        ...
        buff.push(GVMe::lbl_jump(loop2_start));
        buff.push(GVMe::lbl {
            idx: loop2_end,
            name: format!(""),
        });
        ...
        buff.push(GVMe::LOAD(mod_res));
        buff.push(GVMe::jnz(fix_mod));
        buff.push(GVMe::STORE(mod_res_rtn));

        buff.push(GVMe::LOAD(sign_flag));
        buff.push(GVMe::jpos(skip_sign));

        self.const_in_acc(&zero, &mut buff);
        buff.push(GVMe::SUB(div_res));
        buff.push(GVMe::STORE(div_res));
        ...
        buff.push(GVMe::LOAD(arg1_positive));
        buff.push(GVMe::jneg(arg1_is_in_fact_negative));

        // arg1 pos, arg2 pos
        let arg1_pos_and_arg2_negative = self.next_label();
        buff.push(GVMe::LOAD(arg2_positive));
        buff.push(GVMe::jneg(arg1_pos_and_arg2_negative));
        // x>0 y>0 -> nothing
        buff.push(GVMe::LOAD(mod_res));
        buff.push(GVMe::STORE(mod_res_rtn));
        buff.push(GVMe::LOAD(div_res));
        ...
        buff.push(GVMe::LOAD(arg2_positive));
        buff.push(GVMe::jneg(arg1_neg_and_arg2_neg));
        // x<0 y>0 -> q = -1 - q and r = y - r
        self.const_in_acc(&m_one, &mut buff);
        buff.push(GVMe::SUB(div_res));
        buff.push(GVMe::STORE(div_res_rtn));
        buff.push(GVMe::LOAD(arg2_cpy));
        buff.push(GVMe::SUB(mod_res));
        buff.push(GVMe::STORE(mod_res_rtn));
        buff.push(GVMe::RTRN(proc_info.return_address));
    ...
    pub fn compile_mod_builtin(&mut self, mut buff: Vec<GVMe>) -> Result<Vec<GVMe>, String> {
        let proc_info = self
            .proc_info
        ...
        // if b == 0
        buff.push(GVMe::LOAD(arg2));
        buff.push(GVMe::jnz(arg_2_zero.clone()));
        self.const_in_acc(&zero, &mut buff);
        buff.push(GVMe::STORE(mod_res_rtn));
        buff.push(GVMe::RTRN(proc_info.return_address));
        buff.push(GVMe::lbl {
