...
static const uint16_t ts_parse_table[LARGE_STATE_COUNT][SYMBOL_COUNT] = {
  ...
  [1] = {
    [sym_program_all] = STATE(107),
    [sym_procedures] = STATE(75),
    [sym_procedure] = STATE(40),
    [sym_main] = STATE(100),
    [aux_sym_procedures_repeat1] = STATE(40),
...
static const TSParseActionEntry ts_parse_actions[] = {
  ...
  [29] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_commands_repeat1, 2, 0, 18), SHIFT_REPEAT(34),
  [32] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_commands_repeat1, 2, 0, 18),
  [34] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_commands_repeat1, 2, 0, 18), SHIFT_REPEAT(32),
  [37] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_commands_repeat1, 2, 0, 18), SHIFT_REPEAT(24),
  [40] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_commands_repeat1, 2, 0, 18), SHIFT_REPEAT(105),
  [43] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_commands_repeat1, 2, 0, 18), SHIFT_REPEAT(69),
  [46] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_commands_repeat1, 2, 0, 18), SHIFT_REPEAT(45),
  [49] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_commands_repeat1, 2, 0, 18), SHIFT_REPEAT(60),
  ...
  [58] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_identifier, 4, 0, 32),
  [60] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_identifier, 4, 0, 32),
  ...
  [70] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_command, 5, 0, 34),
  [72] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_command, 5, 0, 34),
  [74] = {.entry = {.count = 1, .reusable = true}}, SHIFT(97),
  [76] = {.entry = {.count = 1, .reusable = true}}, SHIFT(76),
  [78] = {.entry = {.count = 1, .reusable = true}}, SHIFT(68),
  [80] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_command, 2, 0, 17),
  [82] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_command, 2, 0, 17),
  [84] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_command, 3, 0, 26),
  [86] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_command, 3, 0, 26),
  [88] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_command, 3, 0, 27),
  [90] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_command, 3, 0, 27),
  [92] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_command, 7, 0, 38),
  [94] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_command, 7, 0, 38),
  [96] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym_commands_repeat1, 1, 0, 8),
  [98] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_commands_repeat1, 1, 0, 8),
  [100] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_command, 4, 0, 33),
  [102] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_command, 4, 0, 33),
  [104] = {.entry = {.count = 1, .reusable = true}}, SHIFT(99),
  [106] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_command, 5, 0, 36),
  [108] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_command, 5, 0, 36),
  [110] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_command, 5, 0, 35),
  [112] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_command, 5, 0, 35),
  [114] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_command, 9, 0, 39),
  [116] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_command, 9, 0, 39),
  [118] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_command, 9, 0, 40),
  [120] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_command, 9, 0, 40),
  [122] = {.entry = {.count = 1, .reusable = true}}, SHIFT(38),
  [124] = {.entry = {.count = 1, .reusable = false}}, SHIFT(38),
  [126] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_expression, 1, 0, 28),
  ...
  [144] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_procedures_repeat1, 2, 0, 0), SHIFT_REPEAT(72),
  [147] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_procedures_repeat1, 2, 0, 0),
  [149] = {.entry = {.count = 1, .reusable = true}}, SHIFT(47),
  [151] = {.entry = {.count = 1, .reusable = true}}, SHIFT(78),
  [153] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_procedures, 1, 0, 2),
  [155] = {.entry = {.count = 1, .reusable = true}}, SHIFT(18),
  [157] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_declarations, 2, 0, 10),
  [159] = {.entry = {.count = 1, .reusable = true}}, SHIFT(62),
  [161] = {.entry = {.count = 1, .reusable = true}}, SHIFT(81),
  [163] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_args_decl, 2, 0, 13),
  [165] = {.entry = {.count = 1, .reusable = true}}, SHIFT(49),
  [167] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_declaration, 1, 0, 4),
  ...
  [175] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_declarations, 1, 0, 5),
  [177] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_declarations_repeat1, 2, 0, 21),
  [179] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_declarations_repeat1, 2, 0, 21), SHIFT_REPEAT(62),
  [182] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_args_decl_repeat1, 2, 0, 23),
  [184] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_args_decl_repeat1, 2, 0, 23), SHIFT_REPEAT(49),
  [187] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_args_decl, 1, 0, 7),
  [189] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_condition, 3, 0, 31),
  [191] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_args, 1, 0, 7),
  [193] = {.entry = {.count = 1, .reusable = true}}, SHIFT(96),
  [195] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_args, 2, 0, 13),
  [197] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_args_repeat1, 2, 0, 23),
  [199] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_args_repeat1, 2, 0, 23), SHIFT_REPEAT(96),
  ...
  [210] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_args_decl_repeat1, 2, 0, 22),
  [212] = {.entry = {.count = 1, .reusable = true}}, SHIFT(44),
  [214] = {.entry = {.count = 1, .reusable = true}}, SHIFT(41),
  [216] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_arg_decl, 2, 0, 11),
  [218] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_procedure, 6, 0, 24),
  [220] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_procedure, 6, 0, 25),
  [222] = {.entry = {.count = 1, .reusable = true}}, SHIFT(85),
  [224] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_arg_decl, 1, 0, 6),
  [226] = {.entry = {.count = 1, .reusable = true}}, SHIFT(104),
  [228] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_declarations_repeat1, 2, 0, 20),
  [230] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_declaration, 6, 0, 37),
  [232] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_procedure, 5, 0, 14),
  [234] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_procedure, 7, 0, 30),
  [236] = {.entry = {.count = 1, .reusable = true}}, SHIFT(127),
  [238] = {.entry = {.count = 1, .reusable = true}}, SHIFT(11),
  [240] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_main, 5, 0, 16),
  ...
  [252] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_main, 6, 0, 29),
  [254] = {.entry = {.count = 1, .reusable = true}}, SHIFT(9),
  [256] = {.entry = {.count = 1, .reusable = true}}, SHIFT(95),
  [258] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_proc_head, 3, 0, 6),
  ...
  [268] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_main, 5, 0, 19),
  [270] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_proc_call, 4, 0, 12),
  [272] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_main, 4, 0, 0),
  [274] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_program_all, 1, 0, 1),
  [276] = {.entry = {.count = 1, .reusable = true}}, SHIFT(89),
  [278] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_proc_call, 3, 0, 6),
  ...
  [290] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_proc_head, 4, 0, 12),
  [292] = {.entry = {.count = 1, .reusable = true}}, SHIFT(23),
  [294] = {.entry = {.count = 1, .reusable = true}}, SHIFT(35),
  [296] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_expression, 3, 0, 31),
  ...
  [330] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_program_all, 2, 0, 3),
